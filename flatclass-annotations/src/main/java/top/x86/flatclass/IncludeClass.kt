...
@Repeatable
annotation class IncludeClass(
    val targetClass             : KClass<*>, //被包括的类
    val genConstructor          : Boolean = true,
    val fieldName               : String = "", //如果flat为false, 可以手动指定将被包含的类包装到某个属性名里。
    val flat                    : Boolean = true, //true表示将被包含的类展开到使用该注解的类。
